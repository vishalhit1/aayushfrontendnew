...
const Testimonials = () => {
    ...
    useEffect(() => {
        (async () => {
            try {
                const res = await API.get("/api/hometestimonial");
            ...
            <Container>
                <div className='testimonails-section' ref={sectionRef}>
                    ...
                    <div className="testimonial-counter">
                        <div className="row">
                            <Col lg={2}>
                                <h6 className="display-61">
                                    <span className="count-digit">{counts.doctors}</span>+
                                </h6>
                                <hr />
                                <p>Doctors Available</p>
                            </Col>
                            <Col lg={2}>
                                <h6 className="display-61 secondary-count">
                                    <span className="count-digit">{counts.specialities}</span>+
                                </h6>
                                <hr />
                                <p>Specialities</p>
                            </Col>
                            <Col lg={2}>
                                <h6 className="display-61 purple-count">
                                    <span className="count-digit">{formatNumber(counts.bookings)}</span>
                                </h6>
                                <hr />
                                <p>Bookings Done</p>
                            </Col>
                            <Col lg={2}>
                                <h6 className="display-61 warning-count">
                                    <span className="count-digit">{counts.labTests}</span>+
                                </h6>
                                <hr />
                                <p>Lab Tests Available</p>
                            </Col>
                            <Col lg={2}>
                                <h6 className="display-61 pink-count">
                                    <span className="count-digit">{counts.testPackages}</span>+
                                </h6>
                                <hr />
                                <p>Test Packages</p>
                            </Col>
