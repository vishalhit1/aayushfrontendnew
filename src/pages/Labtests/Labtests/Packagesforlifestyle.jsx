...
const Packagesforlifestyle = () => {
    ...
    return (
        <div className='packageforlifestyle-css'>
            <Container className='aayush-new-packages'>
                <Row>
                    <Col lg={12} className='test-popularws'>
                        <h3>Packages For Lifestyle Concerns</h3>
                    </Col>
                </Row>
                            ...
                            <div key={pkg._id}>
                                <div style={{ cursor: "pointer" }}
                                    ...
                                    <div className='popular-test-content'>
                                        ...
                                        <p>{pkg.nooftest}+ Tests Included</p>
...
export default Packagesforlifestyle