...
import nopatient from "../../assets/nopatient.gif"
import { API_URL } from "../../../config";

const LobbyDoctorPatient = () => {
  ...
  const fetchPatients = async () => {
    try {
      ...
      if (!selectedPatient && fetched.length) {
        ...
        {patients.length === 0 ? (
          ...
          <div className="selection-abcd">
                ...
                <div className="col-lg-4" key={p._id}>
                  ...
                  >
                    ...
                    <div className="patient-actions">
                      ...
                      <button className="pat-delete" onClick={(e) => { e.stopPropagation(); handleDelete(p._id); }}><i className="fa fa-trash"></i> Delete</button>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="action-buttons mt-5">
              ...
              <button className="continue-abcd" disabled={!selectedPatient} onClick={() => navigate("/lobby-doctor/slot")}>
            ...
            <form className="patient-selection" onSubmit={handleSubmit}>
              <Row>
                ...
                <Col lg={6}>
                  ...
                  <input className="form-control" type="number" name="age" placeholder="Age" value={form.age} onChange={handleChange} required />
                </Col>
                <Col lg={6}>
                ...
                <Col lg={6}>
                  ...
                  <input className="form-control" name="phone" placeholder="Contact Number" value={form.phone} onChange={handleChange} required />
                </Col>
                <Col lg={6}>
                ...
                <Col lg={6}>
                  <label htmlFor="Prescription">Prescription (Images/PDFs):</label>
                  <div className="mb-2">
                    <input
                      type="file"
                      className="form-control"
              ...
              <button type="submit" className="button-add-update" disabled={loading}>
...
export default LobbyDoctorPatient;