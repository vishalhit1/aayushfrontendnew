  ...
  return (
    <>
      ...
      <div className="container my-4">
        <StepIndicator currentStep={5} />  {/* Slot step */}
        ...
        {addresses.length === 0 ? (
          ...
          <div className="selection-abcd" style={{backgroundColor:'#F9F0ED'}}>
            ...
            <div className="action-buttons mt-5">
              ...
              <button
                ...
                onClick={() => navigate("/lobby-doctor/checkout")}
              >
...
export default LobbyDoctorAddress;
